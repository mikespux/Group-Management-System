...
public class NotesActivity extends AppCompatActivity {
    ...
    TextView textAccountId,add_new,txtAgenda;
    String accountId;
    ...
    public void initializer(){
        ...
        txtAgenda.setText(prefs.getString("agenda", ""));
    ...
    public void showAddMinuteDialog() {
        ...
        final View dialogView = inflater.inflate(R.layout.activity_notes_new, null);
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    if (s_min_agenda.equals("")) {
                        Toast.makeText(getApplicationContext(), "Please enter Note for the Meeting", Toast.LENGTH_LONG).show();
                        return;
                    }
    ...
    public void updateMinute() {
        try {
            ...
            db.close();
            if (rows > 0){
                Toast.makeText(this, "Updated Note Successfully!",
                        Toast.LENGTH_LONG).show();
            }
            else{
                Toast.makeText(this, "Sorry! Could not update Note!",
                        Toast.LENGTH_LONG).show();}
        } catch (Exception ex) {
    ...
    public void deleteCurrentAccount() {
        try {
            ...
            if ( rows == 1) {
                ...
                Toast.makeText(this, "Could not delete Note!", Toast.LENGTH_LONG).show();}
            //}
